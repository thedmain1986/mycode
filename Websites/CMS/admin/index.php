...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            $unapproved_comment_count = checkStatus('posts', 'post_status', 'unapproved');
                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            $element_count = [$post_counts, $post_published_count, $post_draft_counts, $comment_counts, $unapproved_comment_count, $user_counts, $subscriber_count, $category_counts];    
