...
<head>
    ...
    <!-- Custom Override Styles for this template -->
...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Derrick Jones</a>
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <h1 class="text-uppercase">
                    <strong>welcome to the imaginarium</strong>
                </h1>
                <hr>
            </div>
            <div class="col-lg-8 mx-auto">
                <p class="text-faded mb-5">Web Design • Graphic Design • Development</p>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    ...
                    <h3 class="mb-3">Fresh Design</h3>
                    <p class="text-muted mb-0">Out of the box thinking allows from from unique websites!</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    <i class="fas fa-4x fa-paper-plane text-primary mb-3 sr-icon-2"></i>
                    <h3 class="mb-3">Client Relationship</h3>
                    <p class="text-muted mb-0">I help make your vision a reality!</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
                    ...
                    <p class="text-muted mb-0">I'm constantly learning to bring you the freshest ideas.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box mt-5 mx-auto">
...
<section class="bg-dark text-white section2" id="portfolio">
...
<section class="bg-dark text-white section2">
    <div class="container text-center">
        <h2 class="mb-4 text-uppercase"></h2>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto text-center">
                ...
                <hr class="my-4">
                <p class="mb-5">Ready to start your next project with me? That's great! Give me a call or send an email and I will get back to you as soon as possible!</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 mr-auto text-center">
                ...
                <p>
                    <a href="mailto:derrickjones@djsimaginarium.com">derrickjones@djsimaginarium.com</a>
                </p>
            </div>
        </div>
    </div>
